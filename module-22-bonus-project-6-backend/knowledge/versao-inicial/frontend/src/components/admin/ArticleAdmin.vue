        ...
        <b-form>
            ...
            <b-form-group label="Nome:" label-for="article-name">
                <b-form-input id="article-name" type="text"
                              ...
                              placeholder="Informe o nome da artigo ..."></b-form-input>
            </b-form-group>
            <b-form-group label="Descrição:" label-for="article-description">
                <b-form-input id="article-description" type="text"
                              v-model="article.description" required :readonly="mode === 'remove'"
                              placeholder="Informe o descrição do artigo ..."></b-form-input>
            </b-form-group>
            <b-form-group label="Imagem (URL):" label-for="article-image">
                <b-form-input id="article-image" type="text"
                              v-model="article.image" required :readonly="mode === 'remove'"
                              placeholder="Informe a URL da imagem do artigo ..."></b-form-input>
            </b-form-group>
